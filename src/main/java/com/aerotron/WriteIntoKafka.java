...
public class WriteIntoKafka {
	...
	public static class SimpleStringGenerator implements SourceFunction<String> {
		...
		public String mockSensorData() {
            Random randomNum = new Random();
            return  "{\"id\":" + (1 + randomNum.nextInt(4)) + ", \"temperature\":" + (20 + randomNum.nextInt(26)) + ", \"humidity\":" + (30 + randomNum.nextInt(40)) + ",\"timestamp\":" + (new Timestamp(System.currentTimeMillis())) + '}';
		}
	}
